...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # carpeta de model.py
...
def create_model(model):
    ...
    if model == 'default':
        ckpt_path = os.path.join(BASE_DIR, "..", "ai_models", "netG.pth")
        ...
        ckpt_path = os.path.join(BASE_DIR, "..", "ai_models", "improved.bin")
